...
console.log('union with duplicates:', JSON.stringify(union([1, 1, 2], [2, 2, 3], [3, 3, 1]))); // expected: [1,2,3]
...
console.log('union mixed valid/invalid:', JSON.stringify(union([1, 2], null, [3]))); // expected: [1,2,3]
console.log('union preserves first order:', JSON.stringify(union([3, 1, 2], [2, 1, 3]))); // expected: [3,1,2]
