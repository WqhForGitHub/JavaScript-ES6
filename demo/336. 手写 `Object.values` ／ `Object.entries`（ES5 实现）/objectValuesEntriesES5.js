...
console.log(JSON.stringify(myObjectValues(obj)) === JSON.stringify(Object.values(obj))); // true
console.log(JSON.stringify(myObjectEntries(obj)) === JSON.stringify(Object.entries(obj))); // true
