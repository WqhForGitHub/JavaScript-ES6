...
console.log(
  "intersection basic:",
  JSON.stringify(intersection([2, 1, 3], [4, 2, 1], [1, 2])),
); // expected: [2,1]
console.log(
  "intersection no overlap:",
  JSON.stringify(intersection([1, 2], [3, 4])),
); // expected: []
console.log("intersection one array:", JSON.stringify(intersection([1, 2, 3]))); // expected: [1,2,3]
console.log(
  "intersection with duplicates:",
  JSON.stringify(intersection([1, 1, 2, 3], [1, 1, 2])),
); // expected: [1,2]
console.log(
  "intersection with NaN:",
  JSON.stringify(intersection([1, NaN, 2], [NaN, 2, 3])),
); // expected: [NaN,2] (SameValueZero via Set)
console.log("intersection empty:", JSON.stringify(intersection())); // expected: []
console.log(
  "intersection preserves first order:",
  JSON.stringify(intersection([5, 3, 1], [1, 3, 5])),
); // expected: [5,3,1]
