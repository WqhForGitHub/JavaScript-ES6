    ...
    visitor: {
      OptionalMemberExpression(path) {
        ...
        path.replaceWith({
          ...
          test: { type: 'BinaryExpression', operator: '==', left: node.object, right: { type: 'NullLiteral' } },
          consequent: { type: 'Identifier', name: 'undefined' },
          alternate: { type: 'MemberExpression', object: node.object, property: node.property, computed: node.computed },
        });
      },
    },
  };
...
// ===== 测试 =====
const ast = { type: 'Program', body: [{ type: 'ExpressionStatement', expression: { type: 'OptionalMemberExpression', object: { type: 'OptionalMemberExpression', object: { type: 'Identifier', name: 'a' }, property: { type: 'Identifier', name: 'b' }, computed: false, optional: true }, property: { type: 'Identifier', name: 'c' }, computed: false, optional: true } }] };
