...
// 3. 多次调用合并为一次刷新
var tickCount = 0;
nextTick(function () { tickCount++; console.log('tick A, count =', tickCount); });
nextTick(function () { tickCount++; console.log('tick B, count =', tickCount); });
nextTick(function () { tickCount++; console.log('tick C, count =', tickCount); });
