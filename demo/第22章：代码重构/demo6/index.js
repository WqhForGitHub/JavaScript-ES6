...
// ---------- 重构前 ----------
const user1 = { name: 'sven', age: 30 };
const greeting1 = '你好，我叫' + user1.name + '，今年' + user1.age + '岁。';
...
// ---------- 重构前：回调地狱 ----------
const getUserBefore = function (userId, callback) {
  setTimeout(function () {
    callback({ id: userId, name: 'sven' });
  }, 100);
};

const getOrdersBefore = function (userName, callback) {
  setTimeout(function () {
    callback([
      { id: 1, item: '书' },
      { id: 2, item: '笔' },
...
const getOrdersPromise = function (userName) {
  return new Promise(function (resolve) {
    setTimeout(function () {
      resolve([
        { id: 1, item: '书' },
...
// ---------- 重构前 ----------
const person1 = { name: 'sven', age: 30, city: '杭州' };
const name3 = person1.name;
const age3 = person1.age;
const city3 = person1.city;
...
// 函数参数解构
// ---------- 重构前 ----------
const createUserBefore = function (options) {
