...
var Order = function(total, currency) {
  this._total = total;
...
var customer2 = new Customer2('李四');
...
console.log('违反原则: document.querySelector("div.container").children[0].children[2].style.color = "red"');
...
var Dashboard = function(car) {
  this.car = car;
};

Dashboard.prototype.displayStatus = function() {
  var temp = this.car.getEngineTemperature();
  var status = this.car.isOverheating() ? '过热!' : '正常';
  console.log('[Dashboard] 引擎温度: ' + temp + '°C, 状态: ' + status);
};

// Driver 只与 Dashboard 交互
var Driver2 = function(name, dashboard) {
  this.name = name;
...
var myCar2 = new Car2();
var dashboard = new Dashboard(myCar2);
var driver2 = new Driver2('王五', dashboard);
