...
function getScrollPosition(target) {
  let left = 0, top = 0, maxScrollX = 0, maxScrollY = 0;
  ...
  if (!target || target === window || target === document) {
    if (typeof window !== 'undefined') {
      ...
      if (typeof document !== 'undefined') {
        ...
        if (!left) left = (docEl && docEl.scrollLeft) || (body && body.scrollLeft) || 0;
        if (!top) top = (docEl && docEl.scrollTop) || (body && body.scrollTop) || 0;
        const scrollWidth = (docEl && docEl.scrollWidth) || (body && body.scrollWidth) || 0;
        const scrollHeight = (docEl && docEl.scrollHeight) || (body && body.scrollHeight) || 0;
        const clientWidth = (docEl && docEl.clientWidth) || (window.innerWidth) || 0;
        const clientHeight = (docEl && docEl.clientHeight) || (window.innerHeight) || 0;
...
// ---------- Test cases ----------
console.log('getScrollPosition is a function:', typeof getScrollPosition === 'function');
...
// At-bottom element.
const bottom = { nodeType: 1, scrollLeft: 500, scrollTop: 1600, scrollWidth: 1000, scrollHeight: 2000, clientWidth: 500, clientHeight: 400 };
