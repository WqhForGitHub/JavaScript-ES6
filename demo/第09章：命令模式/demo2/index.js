...
var MoveCommand = function(receiver, newPos) {
...
console.log('\n--- 执行一系列移动命令 ---');
var moveCommand1 = new MoveCommand(ball, 10);
executeCommand(moveCommand1);

var moveCommand2 = new MoveCommand(ball, 25);
executeCommand(moveCommand2);

var moveCommand3 = new MoveCommand(ball, 40);
