...
var getFlashUploadObj = function() {
  if (supportFlash()) { // 假设有 supportFlash 函数
...
var getActiveUploadObjMock = function() {
  console.log('尝试 ActiveX 上传...不支持');
  return false;
};

var getFlashUploadObjMock = function() {
  console.log('尝试 Flash 上传...不支持');
  return false;
};

var getFormUploadObjMock = function() {
...
var iteratorUploadObj = function() {
  var uploadObjs = [getActiveUploadObjMock, getFlashUploadObjMock, getFormUploadObjMock];
...
var iteratorUploadObj2 = function() {
  var uploadObjs = [getHtml5UploadObj, getActiveUploadObjMock, getFlashUploadObjMock, getFormUploadObjMock];
  for (var i = 0, fn; fn = uploadObjs[i++];) {
    var uploadObj = fn();
    if (uploadObj !== false) {
      return uploadObj;
...
var uploadObj2 = iteratorUploadObj2();
