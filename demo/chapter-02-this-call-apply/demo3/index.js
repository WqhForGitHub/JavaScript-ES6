...
Function.prototype.bind = function (context) {
  ...
  return function () {
    // 合并预设参数和调用时传入的参数
    const runtimeArgs = Array.prototype.slice.call(arguments);
    const finalArgs = presetArgs.concat(runtimeArgs);
...
Function.prototype.bind = function (context) {
  ...
  const fBound = function () {
    ...
    const bindContext = this instanceof fBound ? this : context;
...
const greetAnne = greet.bind(obj2, 'Hello');
...
// 绑定预设 name 参数
const PersonWithName = Person.bind(null, 'sven');

const p = new PersonWithName(25);
